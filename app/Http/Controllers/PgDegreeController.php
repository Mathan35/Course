...
class PgDegreeController extends Controller
{
    /**
    ...
    public function store(EducationRequest $request)
    {
        ...
        $ugDegree->save();
        return redirect()->back()->with('success', 'Pg Degree successfully Updated');
    }
    ...
    {
        $getDegree = UserPgDegree::find($id);
        return view('edit-pg-degree', compact('getDegree'));
    }
