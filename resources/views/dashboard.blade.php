            ...
            <div class="row mt-4 mb-4">
                <div class="col-lg-4 mb-5 text-center">
                    <div class="card h-100 shadow border-10" style="border-radius:2.25rem !important;">
                        <img style="border-radius: 2.25rem 2.25rem 0rem 0rem;" class="card-img-top" src="{{asset('own/img/education.png')}}" alt="..." />
                ...
                <div class="col-lg-4 mb-5 text-center">
                    <div class="card h-100 shadow border-10" style="border-radius:2.25rem !important;">
                        <img style="border-radius: 2.25rem 2.25rem 0rem 0rem;" class="card-img-top" src="{{asset('own/img/enquiry.png')}}" alt="..." />
                        <div class="card-body p-4 text-white" style="background: linear-gradient(180deg,#f44881,#ec454f);">
                ...
                <div class="col-lg-4 mb-5 text-center">
                    <div class="card h-100 shadow border-10" style="border-radius:2.25rem !important;">
                        <img style="border-radius: 2.25rem 2.25rem 0rem 0rem;" class="card-img-top" src="{{asset('own/img/payment.png')}}" alt="..." />
                        <div class="card-body p-4 text-white" style="background: linear-gradient(180deg,#f44881,#ec454f);">
