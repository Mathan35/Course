                  ...
                  <table class="table table-borderless datatable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="d-flex">
                                <div class="p-1">
                                    <a class=" btn btn-outline-success btn-sm" href="{{route('batch.edit',$item->id)}}"> <i class="bi bi-pencil-fill"></i></a>
                                </div>

                                <div class="p-1">
                                <form id="delete-form" class="" method="POST" action="{{route('batch.destroy', $item->id)}}">
                                    {{ csrf_field() }}
                                    {{ method_field('DELETE') }}
